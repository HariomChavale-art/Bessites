...
const SITE_LIST = [
  ...
  { name: "Nikonsmallworld", url: "https://nikonsmallworld.com", cat: ["Photography", "Education"], desc: "Microscopy photography competition and archive." },
  ...
  { name: "Startmycar", url: "https://startmycar.com", cat: ["Tools"], desc: "Automotive manuals and maintenance guides." },
  { name: "Cymath", url: "https://cymath.com", cat: ["Education"], desc: "Solve math problems instantly with steps." },
  { name: "Splitmysong", url: "https://splitmysong.com", cat: ["Audio", "AI"], desc: "AI-powered stem separation for music." },
  { name: "Futureme", url: "https://futureme.org", cat: ["Fun"], desc: "Write a letter to your future self." },
  { name: "Pointerpointer", url: "https://pointerpointer.com", cat: ["Fun"], desc: "A person points at your cursor, wherever it is." },
  { name: "Strobecool", url: "https://strobe.cool", cat: ["Fun", "Photography"], desc: "Interactive optical illusion generator." },
  { name: "Thispersondoesnotexist", url: "https://thispersondoesnotexist.com", cat: ["AI", "Photography"], desc: "AI-generated realistic human faces." },
  { name: "Asoftmurmur", url: "https://asoftmurmur.com", cat: ["Audio", "Productivity"], desc: "Ambient sound generator for focus and sleep." },
  { name: "Removebg", url: "https://remove.bg", cat: ["Tools", "AI"], desc: "Remove image backgrounds automatically." },
  { name: "Sweezycursors", url: "https://sweezy-cursors.com", cat: ["Design", "Fun"], desc: "Custom mouse cursors for Chrome." },
  { name: "Storytribe", url: "https://storytribeapp.com", cat: ["Design"], desc: "Easy-to-use storyboard and comic creator." },
  { name: "Mapitapp", url: "https://mapitapp.cc", cat: ["Travel"], desc: "Simplified travel planning and mapping." },
  { name: "F4map", url: "https://demo.f4map.com", cat: ["3D", "Travel"], desc: "Full 3D interactive map of the world." },
  { name: "Animejs", url: "https://animejs.com", cat: ["Developer", "Design"], desc: "Powerful JavaScript animation library." },
  { name: "Swishy", url: "https://swishy.ai", cat: ["AI", "Audio"], desc: "AI sound effects and voice generator." },
  { name: "Higgsfield", url: "https://higgsfield.ai", cat: ["AI", "Design"], desc: "AI-powered video generation for social media." },
  { name: "Papermau", url: "https://papermau.blogspot.com", cat: ["Design", "Education"], desc: "Massive archive of free paper models." },
  { name: "Adam", url: "https://adam.new", cat: ["Productivity", "AI"], desc: "AI meeting assistant for focused teams." },
  { name: "Skilllync", url: "https://resources.skill-lync.com", cat: ["Education", "Developer"], desc: "Advanced engineering career resources." },

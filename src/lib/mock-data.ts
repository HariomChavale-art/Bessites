...
const RAW_SITES = [
  ...
  { name: "v0 by Vercel", title: "v0 by Vercel | Generative UI & Full-Stack React Code", url: "https://v0.dev", cat: ["AI", "Developer", "Design"], desc: "v0 is a generative user interface system built by Vercel that turns natural language prompts and design screenshots into production-ready React, Next.js, and Tailwind CSS code.", pricing: "Freemium" },
  { name: "Lovable", title: "Lovable | Full-Stack AI Software Engineer", url: "https://lovable.dev", cat: ["AI", "Developer", "Startups"], desc: "Lovable is an autonomous full-stack AI development platform that builds, tests, and deploys complete web applications from conversational prompts.", pricing: "Freemium" },
  ...
  { name: "ReadCV", title: "ReadCV | Professional Profiles & Creative Network", url: "https://read.cv", cat: ["Design", "Jobs", "Interesting"], desc: "ReadCV is a minimalist professional network and interactive resume builder tailored for designers, engineers, and creative builders.", pricing: "Free" },
  ...
  { name: "Stripe", title: "Stripe | Financial Infrastructure for the Internet", url: "https://stripe.com", cat: ["Payments & Global Commerce"], desc: "Stripe is the world's leading financial infrastructure platform, allowing businesses to accept payments and manage subscriptions.", pricing: "Freemium" },
  { name: "Cloudflare", title: "Cloudflare Workers | Serverless Edge Computing & CDN", url: "https://workers.cloudflare.com", cat: ["Edge Computing & Web Security"], desc: "Lightweight serverless execution environment that runs JavaScript and WebAssembly code directly at the edge.", pricing: "Freemium" },
  ...
  { name: "LaunchDarkly", title: "LaunchDarkly | Feature Flagging & Experimentation Platform", url: "https://launchdarkly.com", cat: ["DevOps & Continuous Delivery"], desc: "Enterprise feature management platform that enables engineering teams to control software releases using live flags.", pricing: "Paid" },
  { name: "Sentry", title: "Sentry | Real-Time Error Tracking & Code Observability", url: "https://sentry.io", cat: ["Application Monitoring & Observability"], desc: "Real-time error tracking and performance observability platform designed for modern web and mobile applications.", pricing: "Freemium" },
  ...
  { name: "Datadog", title: "Datadog | Cloud Monitoring & Security Analytics", url: "https://www.datadoghq.com", cat: ["Application Monitoring & Observability"], desc: "Observability and cybersecurity analytics platform that monitors cloud infrastructure and network performance.", pricing: "Paid" },
  { name: "HeyGen", title: "HeyGen | Generative AI Video & Photorealistic Avatars", url: "https://www.heygen.com", cat: ["AI Video Generation & Digital Avatars"], desc: "AI video generation studio that creates studio-quality spokesperson videos with lip-synced avatars.", pricing: "Freemium" },
  ...
  { name: "SurferSEO", title: "SurferSEO | Content Intelligence & Semantic Search Optimization", url: "https://surferseo.com", cat: ["SEO Analytics & Organic Search"], desc: "AI-powered search optimization and content strategy platform that analyzes top-ranking results in real time.", pricing: "Paid" },
  { name: "Hotjar", title: "Hotjar | Heatmaps, Funnels & User Experience Insights", url: "https://www.hotjar.com", cat: ["User Experience & Qualitative Analytics"], desc: "Product experience insights tool that captures how visitors navigate web pages through heatmaps and recordings.", pricing: "Freemium" },
  { name: "Kajabi", title: "Kajabi | All-in-One Creator Commerce & Course Engine", url: "https://kajabi.com", cat: ["Creator Economy & Digital Course Platforms"], desc: "Enterprise-grade monetization platform that empowers educators and creators to sell digital courses.", pricing: "Paid" },
  { name: "HubSpot", title: "HubSpot | Inbound Marketing, Sales & CRM Suite", url: "https://www.hubspot.com", cat: ["CRM & Enterprise Sales Automation"], desc: "Customer relationship management and inbound marketing ecosystem designed to scale growing businesses.", pricing: "Freemium" },
  { name: "Ahrefs", title: "Ahrefs | SEO Intelligence & Competitive Backlink Index", url: "https://ahrefs.com", cat: ["SEO Analytics & Organic Search"], desc: "Search engine optimization toolset powered by a live web crawler and backlink database.", pricing: "Paid" },
  { name: "axe DevTools", title: "axe DevTools | Automated Web Accessibility Testing", url: "https://www.deque.com/axe/devtools/", cat: ["Web Accessibility & Compliance"], desc: "Automated accessibility testing extension and CI/CD tool used by developers to fix compliance violations.", pricing: "Freemium" },
  { name: "Buffer", title: "Buffer | Multi-Channel Social Media Growth & Scheduling", url: "https://buffer.com", cat: ["Social Media Management & Publishing"], desc: "Visual social media scheduling and audience engagement platform for businesses and creators.", pricing: "Freemium" },
  { name: "LambdaTest", title: "LambdaTest | Cloud Cross-Browser & Real Device Testing", url: "https://www.lambdatest.com", cat: ["Developer Testing & Cloud Device Labs"], desc: "Cloud testing platform that allows engineers to run tests across over 3,000 combinations of browsers.", pricing: "Freemium" },
  { name: "Shadcn UI", title: "shadcn/ui | Beautifully Designed Reusable React Components", url: "https://ui.shadcn.com", cat: ["Component Libraries & Design Systems"], desc: "Open-source collection of accessible, copy-paste React components built on top of Radix UI primitives.", pricing: "Free" },
  { name: "Sprout Social", title: "Sprout Social | Enterprise Social Listening & Analytics", url: "https://sproutsocial.com", cat: ["Social Media Management & Publishing"], desc: "Enterprise-grade social media management suite that aggregates brand mentions and market sentiment.", pricing: "Paid" },
  { name: "Shopify", title: "Shopify | Global E-Commerce Operating Platform", url: "https://www.shopify.com", cat: ["Payments & Global Commerce"], desc: "Global commerce platform powering millions of online storefronts and checkout systems.", pricing: "Paid" },
];

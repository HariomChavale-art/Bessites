...
const SITE_LIST = [
  ...
  { name: "Convertio", url: "https://convertio.co", cat: ["Tools"], desc: "File converter that supports over 300 formats." },
  { name: "Nikon Small World", url: "https://nikonsmallworld.com", cat: ["Photography", "Education"], desc: "Microscopy photography competition and archive." },
  { name: "LingoHut", url: "https://lingohut.com", cat: ["Education"], desc: "Free language learning for over 50 languages." },
  { name: "FFF", url: "https://fff.cmiscm.com", cat: ["Design", "Fun"], desc: "Interactive collection of browser-based toys." },
  { name: "Start My Car", url: "https://startmycar.com", cat: ["Tools"], desc: "Automotive manuals and maintenance guides." },
  { name: "Cymath", url: "https://cymath.com", cat: ["Education"], desc: "Solve math problems instantly with steps." },
  { name: "Split My Song", url: "https://splitmysong.com", cat: ["Audio", "AI"], desc: "AI-powered stem separation for music." },
  { name: "FutureMe", url: "https://futureme.org", cat: ["Fun"], desc: "Write a letter to your future self." },
  { name: "Pointer Pointer", url: "https://pointerpointer.com", cat: ["Fun"], desc: "A person points at your cursor, wherever it is." },
  { name: "Strobe Cool", url: "https://strobe.cool", cat: ["Fun", "Photography"], desc: "Interactive optical illusion generator." },
  { name: "This Person Does Not Exist", url: "https://thispersondoesnotexist.com", cat: ["AI", "Photography"], desc: "AI-generated realistic human faces." },
  { name: "A Soft Murmur", url: "https://asoftmurmur.com", cat: ["Audio", "Productivity"], desc: "Ambient sound generator for focus and sleep." },
  { name: "Remove.bg", url: "https://remove.bg", cat: ["Tools", "AI"], desc: "Remove image backgrounds automatically." },
  { name: "Photopea", url: "https://photopea.com", cat: ["Design", "Tools"], desc: "Advanced online photo editor like Photoshop." },
  { name: "Sweezy Cursors", url: "https://sweezy-cursors.com", cat: ["Design", "Fun"], desc: "Custom mouse cursors for Chrome." },
  { name: "StoryTribe", url: "https://storytribeapp.com", cat: ["Design"], desc: "Easy-to-use storyboard and comic creator." },
  { name: "MapIt", url: "https://mapitapp.cc", cat: ["Travel"], desc: "Simplified travel planning and mapping." },
  { name: "F4Map", url: "https://demo.f4map.com", cat: ["3D", "Travel"], desc: "Full 3D interactive map of the world." },
  { name: "Anime.js", url: "https://animejs.com", cat: ["Developer", "Design"], desc: "Powerful JavaScript animation library." },
  { name: "Swishy AI", url: "https://swishy.ai", cat: ["AI", "Audio"], desc: "AI sound effects and voice generator." },
  { name: "Higgsfield AI", url: "https://higgsfield.ai", cat: ["AI", "Design"], desc: "AI-powered video generation for social media." },
  { name: "Paper Mau", url: "https://papermau.blogspot.com", cat: ["Design", "Education"], desc: "Massive archive of free paper models." },
  { name: "Adam.new", url: "https://adam.new", cat: ["Productivity", "AI"], desc: "AI meeting assistant for focused teams." },
  { name: "Skill-Lync", url: "https://resources.skill-lync.com", cat: ["Education", "Developer"], desc: "Advanced engineering career resources." },
  { name: "Javalab", url: "https://javalab.org", cat: ["Education"], desc: "Interactive physics and chemistry simulations." },
